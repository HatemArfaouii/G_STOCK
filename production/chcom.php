          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Liste <small>Bonde De Commande</small></h3>
              </div>
...
{ ?>
                        <tr>
                          ...
                          <td><?php echo$r['client_contact'];?></td>
                          <td><?php echo$r['grand_total'];?></td>
                          <td><?php echo$r['order_date'];?></td>
                          <td><Button onclick='printOrderc("<?php echo$r['order_id'];?>")' >Consulter</Button></td>
                        </tr>
<?php } ?>
                      </tbody>
                    </table>
