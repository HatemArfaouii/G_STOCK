          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Liste <small>Fournisseur</small></h3>
              </div>
                    ...
                    <table class="table  table-bordered" id="table" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="dell.php?id=<?php echo $r['id']; ?>">
                          <button class="btn btn-primary" type="button"><i class="fa fa-trash"></i></button></a>
                          <a href="ajfournisseur.php?id=<?php echo $r['id']; ?>">  
                          <button class="btn btn-primary" type="button">  <i class="fa fa-pencil"></i>  </button></a></td>
