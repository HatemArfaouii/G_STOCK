...
if (isset($_POST['aj'])) {
    $sql = "INSERT INTO chaufeur VALUES ('','" . $_POST['nom'] . "')";
...
if (isset($_POST['Mo'])) {
    $sql = "UPDATE  chaufeur  SET  nom='" . $_POST['nom'] . "'";
    if ($conn->query($sql) === true) {

        echo "<script>alert('Modifier avec  succès')</script>";
        header("Location: chchauf.php");
    } else {
        echo "<script>alert('Verifier votre information ')</script>";
    }
}
if (isset($_GET['id'])) {
    $datax = "SELECT * FROM chaufeur  WHERE id='" . $_GET['id'] . "'";
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Ajouter chaufeur <small></small></h2>
