...
if(isset($_POST['submit']))
{
 ...
 if(isset($_POST[$px])){
	 $ctt="quantity".$x."";
	 $y=$_POST[$px];
  $sql = "INSERT INTO detfact  VALUES ('".$z."','".$y."','".$_POST[$ctt]."')";
 $Data = $connect->query($sql);
...
<!-- This data list will be edited through javascript     -->
            ...
            <input type="text" class="form-control"  list="datalist" onkeyup="ac(this.value);" id="clientName" name="clientName" placeholder="Client Name" autocomplete="true" />
			                   ...
			                   <select data-live-search="true" class="form-control selectpicker" name="productName1" id="productName<?php echo $x; ?>" onchange="vv(<?php echo $x; ?>);addRow();clxx();" >
                    <option value="">~~SELECT~~</option>
                    <?php
                      $productSql = "select * from client";
                      $productData = $connect->query($productSql);

                      while($row = $productData->fetch_array()) {     
                                 
                      echo $row['nom']." Téléphone:". $row['tel'];  
                      } // /while 
          ...
          <br>
		        ...
		        <div class="form-group">
          <label for="orderDate" class="col-sm-2 control-label">Telephone</label>
          <div class="col-sm-10">
            <input type="text" class="form-control " style="width:33%;float:left" id="orderDate" name="orderDate"  value="Telephone" />
 
            <input type="text" class="form-control " style="width:33%;float:left"id="orderDate" name="orderDate" autocomplete="off" value="Adresse" />
 
            <input type="Text" class="form-control " style="width:34%;float:left"id="orderDate" name="orderDate" autocomplete="off" value="MS" />
