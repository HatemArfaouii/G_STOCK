          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Liste <small>Matricule</small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                         <?php $data = "SELECT * FROM matricule ";
...
{ ?>
                    ...
                    <td>
						  <a href="mat.php?id=<?php echo$r['id'];?>"><button class="btn btn-primary" type="button">
                              <spam class="fa fa-pencil"></spam> Modifier</button></a></td>
