...
$sql = "SELECT order_date, client_name, id_client, sum(THT), sum(TVA), sum(natureTVA), sum(natureTVA), sum(TTTC), sum(Acompte), sum(reste) ,order_id FROM orders WHERE id_client = '".$orderId."' and order_status like'1'";
...
produit.des,bl.prix FROM bl
 ...
 WHERE bl.idclient = '".$orderId."' and bl.stat like'1'";
